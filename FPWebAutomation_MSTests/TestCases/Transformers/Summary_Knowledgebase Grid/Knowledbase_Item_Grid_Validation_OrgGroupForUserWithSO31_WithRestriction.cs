...
{
    class Knowledbase_Item_Grid_Validation_OrgGroupForUserWithSO31_WithRestriction
    {
        [TestClass]
        public class Summary_Knowledgebase_Grid
        {
            ...
            [TestMethod]
            public void Add_Knowledbase_Item_OrgGroupForUserWithSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Add Knowledgebase Item assigned to Org Group where user has SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            [Priority(2)]
            public void MarkAsRead_Knowledbase_Item_OrgGroupForUserWithSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Mark As Read Knowledgebase Item assigned to Org Group where user has SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            [Priority(3)]
            public void Delete_Knowledbase_Item_OrgGroupForUserWithSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Delete Knowledgebase Item assigned to Org Group where user has SO 31 access and with restricted viewing");
