...
{
    class Knowledbase_Item_Grid_Validation_UserWithSO31_WithRestriction
    {
        [TestClass]
        public class Summary_Knowledgebase_Grid
        {
            ...
            [TestMethod]
            public void Verify_Knowledbase_Grid_UserWithSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Validate Knowledgebase grid for user with SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            public void Add_Knowledbase_Item_UserWithSO31_WithRestriction()
            {   
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Add Knowledgebase Item assigned to user with SO 31 access and with restricted viewing");
                ...
                /* Add Knowledgebase Item assigned to user with SO #31 access and with restricted viewing */
            ...
            [TestMethod]
            public void Launch_Knowledbase_Item_UserWithSO31_WithRestriction()
            {

                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Launch Knowledgebase Item assigned to user with SO 31 access and with restricted viewing");
             ...
             [TestMethod]
            public void MarkAsRead_Knowledbase_Item_UserWithSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Mark As Read Knowledgebase Item assigned to user with SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            public void Update_Knowledbase_Item_UserWithSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Update Knowledgebase Item assigned to user with SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            public void Delete_Knowledbase_Item_UserWithSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Delete Knowledgebase Item assigned to user with SO 31 access and with restricted viewing");
