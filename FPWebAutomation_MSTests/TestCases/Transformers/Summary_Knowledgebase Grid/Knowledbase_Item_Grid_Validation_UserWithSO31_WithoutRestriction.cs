...
{
    class Knowledbase_Item_Grid_Validation_UserWithSO31_WithoutRestriction
    {
        [TestClass]
        public class Summary_Knowledgebase_Grid
        {
            ...
            [TestMethod]
            public void Verify_Knowledbase_Grid_UserWithSO31_WithoutRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Validate Knowledgebase grid for user with SO 31 access and without restricted viewing");
            ...
            [TestMethod]
            public void Add_Knowledbase_Item_UserWithSO31_WithoutRestriction()
            {
                
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Add Knowledgebase Item assigned to user with SO 31 access and without restricted viewing");
            ...
            [TestMethod]
            public void Launch_Knowledbase_Item_UserWithSO31_WithoutRestriction()
            {

                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Launch Knowledgebase Item assigned to user with SO 31 access and without restricted viewing");
            ...
            [TestMethod]
            public void MarkAsRead_Knowledbase_Item_UserWithSO31_WithoutRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Mark As Read Knowledgebase Item assigned to user with SO 31 access and without restricted viewing");
                ...
                {
                    Assert.IsNull(strFPwebItem);
                    PropertiesCollection.test.Log(Status.Pass, "Data on grid for other user validated for other user and passed");
                }
                catch
                {
                    PropertiesCollection.test.Log(Status.Fail, "Data on grid for other user validated for other user and failed");
                }
                ...
                {
                    Assert.AreEqual(Never, Convert.ToInt32(Summary.CountNever.Text.Substring(0, 1)));
                    PropertiesCollection.test.Log(Status.Pass, "Count of Never items for other user validated for other user and passed");
                }
                catch
                {
                    PropertiesCollection.test.Log(Status.Fail, "Count of Never items for other user validated for other user and failed");
                }

                try
                {
                    Assert.AreEqual(Old, Convert.ToInt32(Summary.CountOld.Text.Substring(0, 1)));
                    PropertiesCollection.test.Log(Status.Pass, "Count of Old items for other user validated for other user and passed");
                }
                catch
                {
                    PropertiesCollection.test.Log(Status.Fail, "Count of Old items for other user validated for other user and failed");
                }
            ...
            [TestMethod]
            public void Update_Knowledbase_Item_UserWithSO31_WithoutRestriction()
                {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Update Knowledgebase Item assigned to user with SO 31 access and without restricted viewing");
            ...
            [TestMethod]
            public void Delete_Knowledbase_Item_UserWithSO31_WithoutRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Delete Knowledgebase Item assigned to user with SO 31 access and without restricted viewing");
