...
{
    class Knowledbase_Item_Grid_Validation_OrgGroupForUserWithoutSO31_WithRestriction
    {
        [TestClass]
        public class Summary_Knowledgebase_Grid
        {
            ...
            [TestMethod]            
            public void Add_Knowledbase_Item_OrgGroupForUserWithoutSO31_WithRestriction()
            {
                /* Add Knowledgebase automation for user without SO 31 access and with restricted viewing */

                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Add Knowledgebase automation assigned to Org Group where user does not have SO 31 access and with restricted viewing");
