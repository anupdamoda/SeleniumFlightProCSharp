...
{
    class Knowledbase_Item_Grid_Validation_OrgGroupForUserWithSO31_WithoutRestriction
    {
        [TestClass]
        public class Summary_Knowledgebase_Grid
        {
            ...
            [TestMethod]
            public void Delete_Knowledbase_Item_OrgGroupForUserWithSO31_WithoutRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Delete Knowledgebase Item assigned to Org Group where user has SO 31 access and without restricted viewing");
