...
{
    class Knowledbase_Item_Grid_Validation_UserWithoutSO31_WithRestriction
    {
        [TestClass]
        public class Summary_Knowledgebase_Grid
        {
            ...
            [TestMethod]
            public void Verify_Knowledbase_Grid_UserWithoutSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Validate Knowledgebase grid for user without SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            public void Add_Knowledbase_Item_UserWithoutSO31_WithRestriction()
            {
                /* Add Knowledgebase automation for user without SO 31 access and with restricted viewing */

                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Add Knowledgebase automation assigned to user without SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            public void Launch_Knowledbase_Item_UserWithoutSO31_WithRestriction()
            {

                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Launch Knowledgebase Item assigned to user without SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            public void MarkAsRead_Knowledbase_Item_UserWithoutSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Mark As Read Knowledgebase Item assigned to user without SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            public void Update_Knowledbase_Item_UserWithoutSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Update Knowledgebase Item assigned to user without SO 31 access and with restricted viewing");
            ...
            [TestMethod]
            public void Delete_Knowledbase_Item_UserWithoutSO31_WithRestriction()
            {
                PropertiesCollection.test = PropertiesCollection.extent.CreateTest("Delete Knowledgebase Item assigned to user without SO 31 access and with restricted viewing");
